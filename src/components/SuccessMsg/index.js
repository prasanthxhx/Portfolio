...
const SuccessMsg = props => {
  const {msgStatus, changeMsgStatus} = props

  const actualMsg =
    msgStatus === 'success' ? 'Message sent successfully' : 'Message not sent'

  const actualMsgSubPara =
    msgStatus === 'success' ? 'Everything seems great' : 'Something went wrong!'

  const onChangeMsgStatus = () => {
    changeMsgStatus('initial')
  }
